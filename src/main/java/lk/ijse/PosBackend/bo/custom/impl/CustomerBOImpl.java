...
public class CustomerBOImpl implements CustomerBO {
    ...
    public boolean saveCustomer(CustomerDTO customerDTO, Connection connection) {
        return customerDao.save(new Customer(customerDTO.getId(),customerDTO.getName(),customerDTO.getAddress(),customerDTO.getContact(),customerDTO.getEmail()),connection);
    }
    ...
    public boolean updateCustomer(CustomerDTO customerDTO, String Id, Connection connection) {
        return customerDao.update(new Customer(customerDTO.getId(),customerDTO.getName(),customerDTO.getAddress(),customerDTO.getContact(),customerDTO.getEmail()),Id,connection);
    }
